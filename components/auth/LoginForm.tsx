...
export default function LoginForm() {
  return (
    <form action="">
      ...
      <AuthInput label="비밀번호" name="password" type="password" placeholder="비밀번호를 입력하세요." className="mb-0" error="비밀번호는 최소 8자 이상이어야 합니다." />
      <BaseButton type="submit" size="xl" variant="primary" className="mt-12 md:mt-15">
        로그인
      </BaseButton>
