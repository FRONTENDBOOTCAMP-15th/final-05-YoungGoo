      ...
      <div className="flex justify-between items-center h-full px-4 xl:px-0 xl:w-6xl xl:mx-auto">
        ...
        <nav>
          <ul id="site-nav" className={[isOpen ? 'block' : 'hidden', `fixed right-4 top-18 p-4 bg-white border border-gray-200 rounded-2xl md:top-24 lg:flex lg:gap-6 lg:items-center lg:static lg:p-0 lg:bg-inherit lg:border-0 lg:rounded-none`].join(' ')}>
            ...
            <li className="mb-2 lg:mb-0">
              <Link href="/login" className="block font-medium text-[14px] md:text-[16px]">
                로그인
              </Link>
            </li>
            <li className="mb-2 lg:mb-0">
              <Link href="/signup" className="block font-medium text-[14px] md:text-[16px]">
                회원가입
              </Link>
            </li>
            <li className="mb-2 lg:mb-0">
              <Link href="/products" className="block font-medium text-[14px] md:text-[16px]">
                영양제 정보
              </Link>
            </li>
            <li className="mb-2 lg:mb-0">
              <Link href="/mypage" className="block font-medium text-[14px] md:text-[16px]">
                마이페이지(임시)
              </Link>
            </li>
            <li>
              <Link href="/subscription" className="block font-medium text-[14px] md:text-[16px]">
                결제(구독)(임시)
              </Link>
            </li>
          </ul>
